...
신불산btn5 = Button(frame3, width=5, padx=10, pady=5, text="첫번째선택", command=신불산_range1, bg="white", fg="black")
신불산btn5.place(x=240, y=50)
신불산btn5 = Button(frame3, width=5, padx=10, pady=5, text="두번째선택", command=신불산_range2, bg="white", fg="black")
신불산btn5.place(x=300, y=50)
신불산btn5 = Button(frame3, width=5, padx=10, pady=5, text="세번째선택", command=신불산_range3, bg="white", fg="black")
...
notebook.add(frame6, text="05. 육부촌")

#로그
육부촌log1 = Button(frame6, width=5, padx=10, pady=5, text="Day1", command=육부촌_Day1, bg="orange", fg="black")
육부촌log1.place(x=0, y=10)
육부촌log2 = Button(frame6, width=5, padx=10, pady=5, text="Day2", command=육부촌_Day2, bg="orange", fg="black")
육부촌log2.place(x=60, y=10)
육부촌log3 = Button(frame6, width=5, padx=10, pady=5, text="Day3", command=육부촌_Day3, bg="orange", fg="black")
육부촌log3.place(x=120, y=10)
육부촌log4 = Button(frame6, width=5, padx=10, pady=5, text="Day4", command=육부촌_Day4, bg="orange", fg="black")
육부촌log4.place(x=180, y=10)
육부촌log5 = Button(frame6, width=5, padx=10, pady=5, text="Day_Cho", command=육부촌_Day, bg="orange", fg="black")
육부촌log5.place(x=180, y=10)
#날짜
육부촌btn1 = Button(frame6, width=5, padx=10, pady=5, text="Hold", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn1.place(x=0, y=50)
육부촌btn2 = Button(frame6, width=5, padx=10, pady=5, text="Hold", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn2.place(x=60, y=50)
육부촌btn3 = Button(frame6, width=5, padx=10, pady=5, text="Hold", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn3.place(x=120, y=50)
육부촌btn4 = Button(frame6, width=5, padx=10, pady=5, text="Hold", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn4.place(x=180, y=50)
육부촌btn5 = Button(frame6, width=5, padx=10, pady=5, text="Hold", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn5.place(x=240, y=50)
#함수
육부촌btn1 = Button(frame6, width=5, padx=10, pady=5, text="Reset", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn1.place(x=0, y=90)
육부촌btn2 = Button(frame6, width=5, padx=10, pady=5, text="Auto", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn2.place(x=60, y=90)
육부촌btn3 = Button(frame6, width=5, padx=10, pady=5, text="Cursor", command="육부촌_Log_Id2", bg="white", fg="black")
육부촌btn3.place(x=120, y=90)
육부촌btn4 = Button(frame6, width=5, padx=10, pady=5, text="Range", command=육부촌_범위선택, bg="white", fg="black")
육부촌btn4.place(x=180, y=90)
육부촌btn5 = Button(frame6, width=5, padx=10, pady=5, text="줍줍", command=육부촌_Start1, bg="white", fg="black")
육부촌btn5.place(x=240, y=90)
육부촌btn6 = Button(frame6, width=5, padx=10, pady=5, text="Karavan", command="육부촌_Log_Id2", bg="green", fg="white")
육부촌btn6.place(x=300, y=90)
육부촌btn7 = Button(frame6, width=5, padx=10, pady=5, text="Start(A)", command="육부촌_Log_Id2", bg="green", fg="white")
육부촌btn7.place(x=360, y=90)
