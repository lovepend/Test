...
def schedule_job():    
  ...
  schedule.every().day.at("09:44:00").do(schedule_mobile_start) # 42초 
  schedule.every().day.at("13:44:00").do(schedule_mobile_start) # 42초 
  #schedule.every().day.at("01:03:30").do(schedule_mobile_start) # 42초 ##
  while True:
