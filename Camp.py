...
def schedule_job():    
  ...
  schedule.every().day.at("09:50:00").do(태화연_자동) 
...
신불산btn3 = Button(frame3, width=5, padx=10, pady=5, text="실시간", command=시간입력_실시간, bg="white", fg="black", font = ("", 7))
신불산btn3.place(x=100, y=83)
신불산btn4 = Button(frame3, width=5, padx=10, pady=5, text="줍기", command=시간입력_줍기, bg="green", fg="white", font = ("", 7))
신불산btn4.place(x=150, y=83)
신불산btn5 = Button(frame3, width=5, padx=10, pady=5, text="줍기_광클릭", command=시간입력_줍기1, bg="green", fg="white", font = ("", 7))
...
신불산time_s = Button(frame3, width=5, padx=5, pady=5, text="시작", command=Sinbul_Time, bg="orange", fg="black", font = ("", 7))
...
def job():
  print("Do Job...!!!")
  schedule.every().day.at("09:59:55").do(육부촌_줍줍)
...
육부촌btn7 = Button(frame6, width=5, padx=10, pady=5, text="줍줍실시간", command=육부촌_실시간, bg="green", fg="white", font = ("", 7))
육부촌btn7.place(x=50, y=83)
육부촌btn8 = Button(frame6, width=5, padx=10, pady=5, text="Start(A)", command=육부촌_Start, bg="green", fg="white", font = ("", 7))
육부촌btn8.place(x=100, y=83)
