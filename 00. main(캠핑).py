...
울주btn1 = Button(root, padx=10, pady=5, text="이번에이", command=울주_job, bg="green", fg="white")
울주btn1.grid(row=1, column=0)
울주btn2 = Button(root, padx=10, pady=5, text="이번달순", command=울주_job1, bg="green", fg="white")
울주btn2.grid(row=1, column=1)
울주btn3 = Button(root, padx=10, pady=5, text="다음에이", command=울주_job2, bg="green", fg="white")
