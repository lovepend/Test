...
울주btn3 = Button(frame2, width=5, padx=10, pady=5, text="This(A)", command=울주_job, bg="green", fg="white")
울주btn3.place(x=120, y=50)
울주btn4 = Button(frame2, width=5, padx=10, pady=5, text="This(N)", command=울주_job1, bg="green", fg="white")
울주btn4.place(x=180, y=50)
울주btn5 = Button(frame2, width=5, padx=10, pady=5, text="Next(A)", command=울주_job2, bg="green", fg="white")
