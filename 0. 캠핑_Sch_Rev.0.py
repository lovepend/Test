...
schedule.every().day.at("08:50").do(태화연_자동) # 태화연 자동

schedule.every().day.at("09:50").do(신불산_자동) # 신불산

schedule.every().day.at("10:30").do(대왕암_자동) # 대왕암

schedule.every().day.at("13:50").do(신불산_자동) # 신불산

schedule.every().day.at("14:30").do(대왕암_자동) # 대왕암

schedule.every().day.at("16:48").do(태화연_자동) # 태화연 자동


schedule.every().day.at("16:30").do(대왕암_자동) # 대왕암
