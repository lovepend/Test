...
#함수
신불산btn1 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.1", command=time_controll_01, bg="white", fg="black")
신불산btn1.place(x=0, y=130)
신불산btn2 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.2", command=time_controll_02, bg="white", fg="black")
신불산btn2.place(x=60, y=130)
신불산btn3 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.3", command=time_controll_03, bg="white", fg="black")
신불산btn3.place(x=120, y=130)
신불산btn4 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.5", command=time_controll_05, bg="white", fg="black")
신불산btn4.place(x=180, y=130)
신불산btn5 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.7", command=time_controll_07, bg="white", fg="black")
신불산btn5.place(x=240, y=130)
신불산btn5 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.9", command=time_controll_09, bg="white", fg="black")
신불산btn5.place(x=300, y=130)
신불산btn5 = Button(frame4, width=5, padx=10, pady=5, text="Time 0.1", command=time_controll_10, bg="white", fg="black")
