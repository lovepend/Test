...
def 보안문자_받기():
    text1 = pag.locateOnScreen('./image/01. security.png', region = (0,243,286,306)) #reservation 100%
    if (text1 == None) :
        보안문자_받기()
    else :
        #보안문자 클릭
...
def 결제_page1():
    #다음 클릭
    buttonpostion1 = pag.locateCenterOnScreen('./image/01_1. next.png', region = (1133,820,1287,880), confidence=0.9) #reservation 67%
...
def 결제_page2():
    ...
    pag.hotkey('down')
    #개인정보수집 동의
    buttonpostion2_1 = pag.locateCenterOnScreen('./image/01_2. payment1.png', region = (0,0,1920,1680), confidence=0.9) #reservation 67%    
    pag.click(buttonpostion2_1.x,buttonpostion2_1.y)
    #페이지 선택
    pag.click(1600,800)
    #결제 선택
    buttonpostion2_2 = pag.locateCenterOnScreen('./image/01_2. payment2.png', region = (1100,788,1281,884), confidence=0.9) #reservation 67%
    pag.click(buttonpostion2_2.x,buttonpostion2_2.y)
    time.sleep(0.5)
#신용카드결제
def 결제_page3():
    #신용카드결제 
    buttonpostion3_1 = pag.locateCenterOnScreen('./image/01_3. next1.png', region = (695,597,839,672), confidence=0.9) 
    if (buttonpostion3_1 == None):
        결제_page3()
    else :        
        pag.click(buttonpostion3_1.x,buttonpostion3_1.y) 
        #전체동의
        buttonpostion3_2 = pag.locateCenterOnScreen('./image/01_3. next2.png', region = (695,253,1322,988), confidence=0.9) 
        #다음
        time.sleep(0.2)
...
def 결제_page4():
    #국민 카드 선택
    buttonpostion4_1 = pag.locateCenterOnScreen('./image/01_4. next1.png', region = (827,526,944,573), confidence=0.9) 
    if (buttonpostion4_1 == None):
        ...
        #결제 동의 
        buttonpostion4_2 = pag.locateCenterOnScreen('./image/01_4. next2.png', region = (695,253,1322,988), confidence=0.9) 
        
        pag.click(buttonpostion4_2.x,buttonpostion4_2.y) 
        #다음
        buttonpostion4_3 = pag.locateCenterOnScreen('./image/01_4. next3.png', region = (695,253,1322,988), confidence=0.9) 
        
        pag.click(buttonpostion4_3.x,buttonpostion4_3.y) 
        time.sleep(0.2)
#앱결제
def 결제_page5():
    buttonpostion5 = pag.locateCenterOnScreen('./image/01_5. payment.png', region = (767,335,1224,851), confidence=0.9) #reservation 67%
...
#결제코드보내기       
def 결제_page6():
    button6 = pag.locateCenterOnScreen('./image/01_6. payment.png', region = (767,335,1224,851), confidence=0.9)
    if (button6 == None):
        결제_page6()
    else :
        #코드보내기
...
#이메일 확인
def 결제_page7():
    buttonpostion7 = pag.locateCenterOnScreen('./image/01_7. next.png', region = (1211,663,1304,706), confidence=0.9) #reservation 67%
    if (buttonpostion7 == None):
        결제_page7()
    else :
        #이메일 발송
        
        pag.click(buttonpostion7.x,buttonpostion7.y)
#완료!!!
def 결제_page8():
    buttonpostion8 = pag.locateCenterOnScreen('./image/01_7. next.png', region = (1198,728,1307,795), confidence=0.9) #reservation 67%
    if (buttonpostion8 == None):
        결제_page8()
    else :
        #이메일 발송
        
        pag.click(buttonpostion8.x,buttonpostion8.y)
